...
public class ContentJdbcTemplateRepository {
    ...
    public void createContent(String title, String desc, String status, Type contentType, String URL) {
    ...
    public void updateContent(int id, String title, String desc, String status, Type contentType, String URL) {
